...
with open("/workspaces/matura-2025-r25-3a-stachulemko/src/wyniki/zad3output.txt", "w") as wynik:
    wynik.write(f"{max_liczba} {max_napis}")

print(f"{max_liczba} {max_napis}")
